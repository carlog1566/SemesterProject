    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (int i = 0; i < typesofworkers; i++) {
                ...
                System.out.print("Position (ex. Server, Chef, Host): ");
                tempString = scnr.next();

                tempInt = getIntegerInput(scnr, "Number of Workers in Position (ex. 2, 5, 10): ");

                while(true){
                    try {
                        System.out.print("Percentage Tip For Position (ex. 10, 25.4, 4; MUST EQUAL 100% AT THE END): ");
